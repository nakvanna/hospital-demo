  ...
  <q-page>
    <q-card>
      ...
      <q-card-section class="text-center">
        ...
        <span class="text-subtitle1">From {{stock_data.sup_company}} purchased on {{dateConverted(stock_data.purchased_date)}}</span>
      </q-card-section>
      <q-card-section>
        ...
        >
          ...
          <template v-slot:body="props">
            <q-tr :props="props" class="cursor-pointer" @click="$router.push({path: `/stock/${props.row._id}/view`})">
              ...
              <q-td>
                <span>{{dateConverted(props.row.pay_date)}}</span>
              </q-td>
            </q-tr>
          </template>
        </q-table>
