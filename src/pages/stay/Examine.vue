        ...
        >
          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="full_name" :props="props" class="q-gutter-x-xs">
                {{props.row.full_name}}
              </q-td>
              ...
              <q-td key="exa_date" :props="props" class="q-gutter-x-xs">
                {{dateConverted(props.row.exa_date)}}
              </q-td>
            </q-tr>
          </template>
        </q-table>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {align: 'left', name: 'full_name', label: 'អ្នកជំងឺ', field: 'full_name', sortable: true},
    ...
    computed: {
      getExamines(){
        return this.$store.getters['examine/getExamines'].map((x)=>{
          return {
            ...x,
            full_name: x.patient.lname+' '+x.patient.fname+'( '+  x.patient.llatin+' '+x.patient.flatin+' )',
            room: x.room.name,
          }
        })
      }
