          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <span style="font-size: large">
                {{ props.row.patient.lname+' '+props.row.patient.fname}}
                <br>
                {{ props.row.patient.llatin+' '+props.row.patient.flatin}}
              </span>
              </q-td>
              <q-td key="patient_contact" :props="props">
                <q-input
                  class="col"
                  readonly
                  v-model="props.row.patient.contact"
                  type="textarea"
                  rows="3"
                  square
                  lazy-rules
              ...
              <q-td key="sale_date">
              <span style="font-size: large">
                {{ dateConverted(props.row.sale_date) }}
              </span>
              </q-td>
            </q-tr>
          </template>
...
<script>
  const columns_default = [
    ...
    {align: 'left', name: 'patient_contact', label: 'ទំនាក់ទំនង', field: 'patient_contact'},
